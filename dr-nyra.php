            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="animate__animated animate__fadeInLeft">
                    <div class="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6 border border-gray-100">
                        <span class="text-xs font-semibold uppercase tracking-widest text-medicalTeal">Expert Specialist</span>
                    </div>
                    <h1 class="text-4xl lg:text-6xl font-display font-bold leading-tight mb-6">
                        Dr. Nyra <br> 
                        <span class="text-medicalTeal">MBBS, Dermatology Expert</span>
                    </h1>
                    <p class="text-lg text-gray-500 mb-8 max-w-lg leading-relaxed">
                        Leading the team with a commitment to clinical excellence and international standards of patient care.
                    </p>
                ...
                <div class="relative animate__animated animate__fadeInRight">
                    <div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white bg-white">
                        <img src="assets/images/Dr-nayra.jpg" alt="Dr. Nyra | Chief Consultant | Dencespot" class="w-full h-[400px] object-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-[35px] bg-white">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center mb-[30px]">
                <h2 class="text-3xl md:text-4xl font-display font-bold mb-6">Medical Excellence & Vision</h2>
                ...
                <div class="text-gray-600 space-y-6 text-lg leading-relaxed text-left">
                    <p>Dr. Nyra brings years of specialized experience to Dencespot. Her philosophy is built on delivering natural-looking results through ethical and advanced medical practices.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-[35px] bg-bgLight">
        <div class="container mx-auto px-6">
            <div class="text-center mb-[30px]">
                ...
                <p class="text-gray-500">Why choose Dencespot for your Dr. Nyra | Chief Consultant | Dencespot.</p>
            </div>
