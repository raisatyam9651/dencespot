    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            section.relative.pt-40 .container {
                padding-left: 20px !important;
                padding-right: 20px !important;
            }
            section.relative.pt-40 span {
                font-size: 9px !important;
                letter-spacing: 0.15em !important;
                padding: 6px 14px !important;
                margin-bottom: 16px !important;
            }
            section.relative.pt-40 h1 {
            ...
            section.relative.pt-40 .flex.items-center.justify-center.gap-6 {
                gap: 10px !important;
                font-size: 11px !important;
                flex-wrap: wrap !important;
                justify-content: center !important;
            }
            article.relative.-mt-16 {
            ...
            article .relative.mb-16.rounded-\[3rem\] {
            ...
            article .my-16.bg-bgLight h3 {
                font-size: 20px !important;
                margin-bottom: 12px !important;
                line-height: 1.3 !important;
            }
            article .my-16.bg-bgLight p {
                font-size: 14px !important;
                margin-bottom: 20px !important;
                line-height: 1.7 !important;
            }
            article .my-16.bg-bgLight a,
            article a.inline-block.bg-medicalTeal {
                display: block !important;
                width: 100% !important;
                text-align: center !important;
            ...
            article .p-8.bg-bgLight.rounded-3xl {
                padding: 18px 16px !important;
                border-radius: 16px !important;
            }
            article .p-8.bg-bgLight.rounded-3xl h3 {
                font-size: 16px !important;
                margin-bottom: 8px !important;
                line-height: 1.4 !important;
            }
            article .p-8.bg-bgLight.rounded-3xl p {
                font-size: 14px !important;
                line-height: 1.75 !important;
            ...
            article .absolute.top-0.right-0.w-32 {
        ...
        @media (max-width: 400px) {
            ...
            article .prose h2 { font-size: 18px !important; }
            article .prose h3 { font-size: 16px !important; }
            article .my-16.bg-bgLight {
                padding: 18px 14px !important;
            }
            article .my-16.bg-bgLight h3 {
