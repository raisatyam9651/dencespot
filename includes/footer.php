            ...
            <div class="grid md:grid-cols-4 gap-12 mb-20 border-b border-gray-100 pb-20">
                <div class="col-span-1">
                    ...
                    <div class="flex gap-4">
                        <a href="https://www.facebook.com/DenceSpot/" class="w-10 h-10 bg-bgLight rounded-full flex items-center justify-center text-darkSlate hover:bg-medicalTeal hover:text-white transition-all shadow-sm"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/dencespot/" class="w-10 h-10 bg-bgLight rounded-full flex items-center justify-center text-darkSlate hover:bg-medicalTeal hover:text-white transition-all shadow-sm"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-bgLight p-4 rounded-2xl mb-6">
                        ...
                        <div class="flex justify-between text-[10px] font-bold text-gray-400"><span>Sunday</span> <span>Appointment Only</span></div>
                    </div>
                    <div class="rounded-xl overflow-hidden h-24 border border-gray-100 shadow-sm grayscale hover:grayscale-0 transition-all duration-500">
