            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="animate__animated animate__fadeInLeft">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-display font-bold leading-tight mb-6">
                        ...
                        <span class="text-medicalTeal">in Udyog Vihar</span>
                    </h1>
                    <p class="text-lg text-gray-500 mb-8 max-w-lg leading-relaxed">
                        Stop hair loss right at its source. Reclaim a thicker, healthier head of hair with advanced, scientifically-proven medical treatments by expert dermatologists near Udyog Vihar.
                    </p>
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl border border-gray-50 max-w-[240px]">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-gray-400 mt-1 italic leading-tight">Clinically Proven Hair Regrowth Treatments in Udyog Vihar</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<p>Additionally, we utilize anti-androgen treatments that block the devastating effects of the 5-alpha reductase enzyme locally at the scalp level. This prevents DHT from miniaturizing the hair follicle, physically protecting the root structure and allowing the hair shaft to grow thicker, darker, and significantly stronger.</p>
    ...
    <section class="py-[35px] bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-[30px]">
                ...
                <p class="text-gray-500">Trusted experts providing the most reliable <strong>Hair Fall Treatment in Udyog Vihar</strong> for visible, long-lasting results</p>
            </div>
    ...
    <section class="py-[35px] bg-bgLight">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center mb-[30px]">
                <h2 class="text-4xl font-display font-bold mb-6 italic"><span class="text-medicalTeal">Treatment Cost</span> near Udyog Vihar</h2>
