            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative animate__animated animate__fadeInRight">
                    <div class="relative rounded-[4rem] overflow-hidden shadow-2xl border-8 border-white bg-white">
                        <img src="assets/images/man_success_3.png" alt="Hair Fall Treatment in Sector 56 Result" class="w-full">
    ...
    <section class="py-[35px] bg-bgLight">
        <div class="container mx-auto px-6">
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                <div class="relative">
                    <img src="assets/images/man_success_3.png" alt="Best Hair Fall Treatment in Sector 56" class="rounded-[3rem] shadow-2xl">
