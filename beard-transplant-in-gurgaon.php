    ...
    <div class="container">
        <div class="service-hero-grid">
            ...
            <div class="service-hero-badge mobile-hero-badge">
                <i class="fas fa-user-check"></i> Masculine & Defined Look
            </div>
            ...
            <div class="service-hero-content">
                ...
                <!-- Heading -->
                <h1>Beard Transplant <span>in Gurgaon</span></h1>

                <!-- Description -->
                <p>Get the beard you've always wanted. Whether you have patchy growth or facial scarring, our precision
                    FUE techniques restore density and define your style with 100% natural results.</p>
            ...
            <div class="service-hero-image">
                <img src="images/beard-transplant-hero.png" alt="Beard Transplant Patient"
...
<section class="stats-section">
    <div class="container">
        <div class="stats-grid">
            ...
            <!-- Stat 2: Specialized Surgeons -->
            <div class="stat-item">
                <div class="stat-icon">
                    <i class="fas fa-user-md"></i>
                </div>
                <div class="stat-number">10+</div>
                <div class="stat-label">Specialized Surgeons</div>
            </div>

            <!-- Stat 3: Natural Density -->
            <div class="stat-item">
                <div class="stat-icon">
                    <i class="fas fa-leaf"></i>
                </div>
                <div class="stat-number">100%</div>
                <div class="stat-label">Natural Look</div>
            </div>
...
<!-- Beard Transplant Process Section -->
<section class="benefits-section">
    <div class="container">
        <div style="text-align: center; margin-bottom: 50px;">
            <h2 style="color: #1A2E44;">Beard Restoration Process</h2>
            <p style="color: #666; max-width: 700px; margin: 0 auto;">Our specialized approach ensures facial symmetry
                and direction-perfect hair growth for a seamless look.</p>
        </div>

        <div class="benefits-grid">
            <!-- Step 1 -->
            <div class="benefit-card">
                <div class="benefit-icon-box"><i class="fas fa-pencil-ruler"></i></div>
                <h3>Design & Planning</h3>
                <p>We work with you to design a beard line that complements your facial features, correcting patchiness
                    and defining the cheek and jawline.</p>
            </div>

            <!-- Step 2 -->
            <div class="benefit-card">
                <div class="benefit-icon-box"><i class="fas fa-search-plus"></i></div>
                <h3>Donor Extraction</h3>
                <p>Hair follicles are carefully selected from the back of the scalp (donor area) to match the texture
                    and angle of your facial hair.</p>
            </div>

            <!-- Step 3 -->
            <div class="benefit-card">
                <div class="benefit-icon-box"><i class="fas fa-tools"></i></div>
                <h3>Precision Implantation</h3>
                <p>Follicles are implanted at precise angles and depth to mimic natural beard growth patterns, ensuring
                    high density and flow.</p>
            </div>

            <!-- Step 4 -->
            <div class="benefit-card">
                <div class="benefit-icon-box"><i class="fas fa-clock"></i></div>
                <h3>Recovery & Growth</h3>
                <p>Minimal downtime with tiny scabs healing in a week. New beard hair starts growing in 3-4 months and
                    fully matures in a year.</p>
            </div>
        </div>
    </div>
</section>
