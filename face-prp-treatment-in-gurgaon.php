...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        {"@type": "ListItem", "position": 3, "name": "Face PRP Treatment in Gurgaon", "item": "https://dencespot.com/face-prp-treatment-in-gurgaon"}
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "Face PRP Treatment (Vampire Facial)",
      "procedureType": "https://schema.org/NoninvasiveProcedure",
      "description": "Platelet Rich Plasma facial therapy to heal acne scars, smooth wrinkles, and achieve radiant, youthful skin using your body's own growth factors.",
      "howPerformed": "Blood is drawn, processed to isolate platelet-rich plasma, and then micro-needled into the facial skin to stimulate collagen and cellular regeneration.",
