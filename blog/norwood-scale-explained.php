...
<p>The Norwood scale is the standard way doctors describe male pattern hair loss. It runs from stage 1 (no meaningful loss) to stage 7 (a horseshoe of hair around the sides and back). It exists so two clinicians looking at the same head describe it the same way — and so a patient's progression can be tracked over years rather than guessed at.</p>
...
<h3>Stage 2</h3>
<p>Slight recession at both temples, producing a shallow triangular shape. This is a mature hairline, not necessarily hair loss. The distinction matters: nearly every man's hairline moves back a little from its adolescent position in his twenties and then stops. Treating a mature hairline as a disease is how twenty-two-year-olds end up on the operating table for something that was never going to progress.</p>

<h3>Stage 3</h3>
<p>The first stage Norwood classified as clinically significant balding. The temporal recession is now deep and clearly M-shaped, with the recessed areas either bare or sparsely covered.</p>

<h3>Stage 3 vertex</h3>
<p>A separate designation, not a half-step. The hairline sits at stage 2 or 3, but the crown is thinning independently. This is important because it tells you the process is running in two places at once, which changes how the donor supply has to be budgeted.</p>

<h3>Stage 4</h3>
<p>Frontal recession is more severe, and there is now distinct loss at the crown. A band of hair still runs across the top of the scalp, separating the two areas.</p>

<h3>Stage 5</h3>
<p>Both areas are larger, and the band between them is narrower and thinner. It is still there, but it is visibly failing.</p>

<h3>Stage 6</h3>
<p>The bridge breaks down. The frontal and crown areas merge into one continuous bald area across the top of the scalp.</p>
...
<p><strong>It does not tell you whether you should have surgery.</strong> Three things decide that, and the Norwood stage is not one of them:</p>

<ul>
  <li><strong>Has the loss stabilised?</strong> Operating into actively progressing loss produces an island of transplanted hair with a widening bald area around it. This is the single commonest reason a technically good procedure ages badly.</li>
  <li><strong>What can the donor area actually supply?</strong> Donor density varies enormously between people. Two men at identical Norwood stages can have completely different options, because one has the supply for full coverage and the other does not.</li>
  <li><strong>How old are you, and where is this heading?</strong> A stage 3 at twenty-four is a different clinical problem from a stage 3 at forty-eight. The younger man will very likely progress further, so his plan has to reserve grafts he does not need yet.</li>
</ul>
...
<div class="table-scroll">
  <table class="data">
    <caption class="sr-only">What is typically discussed first at each Norwood stage</caption>
    <thead>
      <tr><th scope="col">Stage</th><th scope="col">What it looks like</th><th scope="col">Usually discussed first</th></tr>
    </thead>
    <tbody>
      <tr><th scope="row" style="color:var(--ink);font-size:15px;font-weight:700;text-transform:none;letter-spacing:0">1–2</th><td>Adolescent or mature hairline; little or no loss</td><td>Usually nothing. Photograph it and review in a year.</td></tr>
      <tr><th scope="row" style="color:var(--ink);font-size:15px;font-weight:700;text-transform:none;letter-spacing:0">2A–3</th><td>Clear temporal recession, M-shaped</td><td>Medical therapy first, especially under thirty. Surgery once the pattern has settled.</td></tr>
