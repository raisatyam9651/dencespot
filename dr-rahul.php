...
<head>
    ...
    <title>Dr. Rahul | Hair Restoration Expert | Dencespot Clinic Gurgaon</title>
    ...
    <link rel="canonical" href="https://dencespot.com/dr-rahul" />
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://dencespot.com/images/doctor-rahul.png",
      "url": "https://dencespot.com/dr-rahul",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "position": 2,
        "name": "Dr. Rahul",
        "item": "https://dencespot.com/dr-rahul"
      }]
    }
    </script>
...
<body class="bg-bgLight font-sans text-darkSlate overflow-x-hidden">
    ...
    <!-- HERO SECTION -->
    <section class="relative min-h-[85vh] flex items-center pt-24 overflow-hidden bg-bgLight">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="animate__animated animate__fadeInLeft">
                    <div class="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-6 border border-gray-100">
                        <span class="text-xs font-semibold uppercase tracking-widest text-medicalTeal">Clinical Expert</span>
                    </div>
                    <h1 class="text-4xl lg:text-6xl font-display font-bold leading-tight mb-6">
                        Dr. Rahul <br> 
                        <span class="text-medicalTeal">Hair Restoration Specialist</span>
                    </h1>
                    <p class="text-lg text-gray-500 mb-8 max-w-lg leading-relaxed">
                        Dedicated to achieving the highest graft survival rates and artistic hairline designs for every patient.
                    </p>
    ...
    <section class="py-[35px] bg-white">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center mb-[30px]">
                <h2 class="text-3xl md:text-4xl font-display font-bold mb-6">Precision & Artistry</h2>
                ...
                <div class="text-gray-600 space-y-6 text-lg leading-relaxed text-left">
                    <p>Dr. Rahul is known for his meticulous approach to follicular unit extraction and his ability to design hairlines that perfectly complement facial features.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-[35px] bg-bgLight">
        <div class="container mx-auto px-6">
            <div class="text-center mb-[30px]">
                ...
                <p class="text-gray-500">Why choose Dencespot for your Dr. Rahul | Hair Restoration Expert | Dencespot.</p>
            </div>
